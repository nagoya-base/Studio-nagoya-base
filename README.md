...
料金改定時の必須フロー:
1. 本文（ヒーロー等）の価格表記を更新
2. `meta description` / `og:description` / `twitter:description` を更新
3. 全ページを横断して価格表記の不一致がないか確認

価格表記の正本:
- 日本語: `平日2時間¥4,000〜 / 土日祝2時間¥5,000〜`
- 英語: `Weekdays 2 hours ¥4,000〜 / Weekends & holidays 2 hours ¥5,000〜`
...
- meta価格一致（平日¥4,000〜 / 土日祝¥5,000〜）を確認したか
