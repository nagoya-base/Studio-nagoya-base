(function () {
  ...
  var EVENT_QUERY_CONFIG = {
    '2026-09-05-classroom': {
      label: '9/5 教室セット コスプレ撮影体験（14:00〜17:00・20分2,000円・仮申込み）',
      noticeHtml: '<p><strong>「9/5 教室セット コスプレ撮影体験」への参加希望（仮申込み）として送信されます。</strong>開催時間は14:00〜17:00です。受付枠・キャンセル規定などの詳細は返信でご案内し、内容にご同意・ご返信いただいた時点で参加確定となります。確定前のキャンセル・変更について、追加のご連絡は不要です。</p>',
      messagePlaceholder: '参加人数、当日の希望時間帯（例：15時台希望など）、その他ご質問があればご記入ください。'
    }
  };
  var queryEvent = null;
